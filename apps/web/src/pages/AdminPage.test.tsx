...
vi.mock('@/api/client', () => ({
  ...
  getPermissionOverview: vi.fn().mockResolvedValue({
    ...
    current_actor_role_codes: ['developer'],
    current_actor_level: 500,
    users: [
      {
        id: 'water-user',
      ...
      level_label: (
        {
          developer: 'L5 · 开发者',
          admin: 'L4 · 管理员',
          operations_lead: 'L3 · 运营负责人',
          live_manager: 'L2 · 直播主管',
          water_pm: 'L1 · 项目 PM',
          primer_pm: 'L1 · 项目 PM',
          powder_pm: 'L1 · 项目 PM',
          viewer: '兼容只读',
...
test('用户与权限页展示五级角色体系、权限矩阵、直播间和飞书群范围', async () => {
  ...
  expect(await screen.findByText('开发者（最高权限）')).toBeInTheDocument()
